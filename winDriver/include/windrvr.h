...
#define WD_VER_STR  WD_PROD_NAME " v" WD_VERSION_STR " Jungo (c) 1997 - 2005 Build Date: " __DATE__ WD_CPU_SPEC WD_DATA_MODEL WD_FILE_FORMAT
...
#define WD_KERNEL_DRIVER_PLUGIN_HANDLE 0xffff0000
    ...
    #define WD_CTL_CODE(wFuncNum) _IOC(_IOC_READ|_IOC_WRITE, 0, wFuncNum, 0)
    #define WD_CTL_DECODE(IoControlCode) _IOC_NR(IoControlCode)
#elif defined(UNIX)
    #define WD_CTL_CODE(wFuncNum) (wFuncNum)
    #define WD_CTL_DECODE(IoControlCode) (IoControlCode)
#else
    // Device type
    #define WD_TYPE 38200
    #define WD_CTL_CODE(wFuncNum) CTL_CODE( WD_TYPE, wFuncNum, METHOD_NEITHER, FILE_ANY_ACCESS)
    #define WD_CTL_DECODE(IoControlCode) ((IoControlCode >> 2) & 0xfff)
#endif
...
#define IOCTL_WD_CARD_REGISTER            WD_CTL_CODE(0x99c)
...
#define IOCTL_WD_EVENT_REGISTER           WD_CTL_CODE(0x99d)
...
#define IOCTL_WD_WATCH_PCI_START          WD_CTL_CODE(0x99e)
